...
public:
	 ...
	 * \return константную ссылку на идентификационный номер данного элемента.
	 */
...
public:
	 ...
	 * \return константную ссылку на имя таблицы.
	 */
...
public:
	...
	static const QString trigger;
	//! \~russian \brief Имя для распознавания строки с именем вкладки данных векторов. Например, "#vectorsname". \details Используется в редакторе в для распознавания имени вектора.
	static const QString triggername;
	 ...
	 * \return константную ссылку на имя вкладки с векторами.
	 */
	const QString& getName() const { return name_; }
...
public:
	 ...
	 * \return константную ссылку на строку, содержащую комментарий.
	 */
